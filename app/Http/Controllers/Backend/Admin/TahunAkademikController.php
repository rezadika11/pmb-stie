...
class TahunAkademikController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.admin.tahun_akademik.index', compact('tahunAkademikOptions'));
    }

    public function create()
    {
        return view('backend.admin.tahun_akademik.create');
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return response()->json(['redirect' => route('admin.tahun_akademik.index')], 200);
        } catch (\Exception $e) {
