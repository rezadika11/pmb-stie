            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                       <a href="{{ route('testimoni.create') }}" class="btn btn-sm btn-primary"><i class="bi bi-plus-square"></i> Tambah</a>
                    </div>
                    <div class="card-body">
...
<script>
   $(document).ready(function() {
        ...
        $('#btnDestroy').click(function (e) {
            ...
            $.ajax({
                url: `{{ route('testimoni.destroy', '') }}/${id}`,
                type: 'DELETE',
                headers: {
