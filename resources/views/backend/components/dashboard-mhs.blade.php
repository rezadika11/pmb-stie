    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <li>
                    <h6>0895360587915 (Devi)</h6>
                </li>
                </ul>
                <br>
                    <p class="text-dark">Untuk pembayaran bisa langsung transfer ke nomer rekening <span class="text-primary">Bank Jateng 2013023169 An. STIE TAMANSISWA BANJARNEGARA</span> </p>
                <br>
