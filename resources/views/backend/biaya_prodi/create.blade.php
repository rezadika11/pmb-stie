            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body text-dark">
                        <form action="{{ route('biaya_prodi.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="id_gelombang" id="id_gelombang"
                                            ...
                                            <option value="{{ $gelombang->id }}" {{ old('id_gelombang')==$gelombang->id
                                                ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="currency-input">
                                            <input type="number" name="biaya_tri_dharma" id="biaya_tri_dharma"
                                                ...
                                                value="{{ old('biaya_tri_dharma') }}" required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="currency-input">
                                            <input type="number" name="biaya_ospek" id="biaya_ospek"
                                                ...
                                                value="{{ old('biaya_ospek') }}" required>
                                        </div>
                                        @error('biaya_ospek')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
