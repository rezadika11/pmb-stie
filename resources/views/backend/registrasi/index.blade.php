            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                       <a href="{{ route('registrasi.create') }}" class="btn btn-sm btn-primary"><i class="bi bi-plus-square"></i> Tambah</a>
                    </div>
                    <div class="card-body">
...
<script>
   $(document).ready(function() {
        $('#dataTable').DataTable({
            ...
            ajax: {
                url: '{{ route('registrasi.datatable') }}',
                type: 'GET'
            },
            columns: [
                { 
        ...
        $('#btnDestroy').click(function (e) { 
            ...
            $.ajax({
                url: `{{ route('registrasi.destroy', '') }}/${id}`,
                type: 'DELETE',
                headers: {
