                        ...
                        <div class="basic-form">
                            <form id="formSimpan">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="name" name="name" class="form-control" placeholder="Masukan Judul" value="{{ old('name', $pendaftaran->name) }}" autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                       <textarea id="editor" name="content">{{ old('content', $pendaftaran->content) }}</textarea>
