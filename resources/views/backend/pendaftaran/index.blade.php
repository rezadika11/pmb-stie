            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                       <a href="{{ route('pendaftaran.create') }}" class="btn btn-sm btn-primary"><i class="bi bi-plus-square"></i> Tambah</a>
                    </div>
                    <div class="card-body">
...
<script>
   $(document).ready(function() {
        $('#dataTable').DataTable({
            ...
            ajax: {
                url: '{{ route('pendaftaran.datatable') }}',
                type: 'GET'
            },
            columns: [
                { 
        ...
        $('#btnDestroy').click(function (e) { 
            ...
            $.ajax({
                url: `{{ route('pendaftaran.destroy', '') }}/${id}`,
                type: 'DELETE',
                headers: {
