<div class="quixnav">
    <div class="quixnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li class="{{ request()->routeIs('dashboard') ? 'mm-active' : '' }}"><a href="{{ route('dashboard') }}"
            ...
            <li
                class="{{ request()->routeIs('pendaftaran*') || request()->routeIs('registrasi*') || request()->routeIs('brosur*') || request()->routeIs('kontak*') ? 'mm-active' : '' }}">
                <a class="has-arrow" href="javascript:void()"
                    aria-expanded="{{ request()->routeIs('pendaftaran*') || request()->routeIs('registrasi*') || request()->routeIs('brosur*') || request()->routeIs('kontak*') ? 'true' : 'false' }}"><i
            ...
            <li
                class="{{ request()->routeIs('banner*') || request()->routeIs('tentang*') ||  request()->routeIs('count*') || request()->routeIs('testimoni*') ? 'mm-active' : '' }}">
                <a class="has-arrow" href="javascript:void()"
                    aria-expanded="{{ request()->routeIs('banner*') || request()->routeIs('tentang*') || request()->routeIs('count*') || request()->routeIs('testimoni*')  ? 'true' : 'false' }}"><i
            ...
            <li class="{{ request()->routeIs(['tahun_akademin.*','gelombang.*']) ? 'mm-active' : '' }}"><a
                    class="has-arrow" href="javascript:void()"
                    aria-expanded="{{ request()->routeIs(['tahun_akademin.*','gelombang.*'])  ? 'true' : 'false' }}"><i
                        class="bi bi-calendar"></i></i><span class="nav-text">Pengaturan Pendaftaran</span></a>
                <ul aria-expanded="{{ request()->routeIs(['tahun_akademin.*','gelombang.*','biaya_prodi.*'])  ? 'true' : 'false' }}"
                    class="mm-collapse {{ request()->routeIs(['tahun_akademin.*','gelombang.*','biaya_prodi.*'])   ? 'mm-show' : '' }}">
                    ...
                    <li class="{{ request()->routeIs('biaya_prodi.*') ? 'mm-active' : '' }}">
                        <a href="{{ route('biaya_prodi.index') }}">
            ...
            {{-- <li class="{{ request()->routeIs('tahun-akademik*') ? 'mm-active' : '' }}"><a
                    href="{{ route('tahun_akademik.index') }}" aria-expanded="false"><i
                        class="bi bi-calendar4"></i><span class="nav-text">Tahun Akademik</span></a></li> --}}

            {{-- <li class="{{ request()->routeIs('kontak*') ? 'mm-active' : '' }}"><a
                    href="{{ route('kontak.index') }}" aria-expanded="false"><i class="bi bi-telephone"></i><span
                        class="nav-text">Kontak</span></a></li> --}}

            {{-- <li class="{{ request()->routeIs('banner*') ? 'mm-active' : '' }}"><a
                    href="{{ route('banner.index') }}" aria-expanded="false"><i class="bi bi-bookmark"></i><span
                        class="nav-text">Banner</span></a></li> --}}
            <li class="nav-label first">Setting</li>
            <li class="{{ request()->routeIs('users*') ? 'mm-active' : '' }}"><a href="{{ route('users.index') }}"
                    aria-expanded="false"><i class="bi bi-people"></i><span class="nav-text">User</span></a></li>
            @elseif (Auth::user()->roles == 'admin')
            <li class="{{ request()->routeIs('pmb*') ? 'mm-active' : '' }}"><a href="{{ route('pmb.index') }}"
                    aria-expanded="false"><i class="bi bi-file-earmark-text"></i><span class="nav-text">PMB</span></a>
            </li>

            {{-- <li class="{{ request()->routeIs('tahun-akademik*') ? 'mm-active' : '' }}"><a
                    href="{{ route('admin.tahun_akademik.index') }}" aria-expanded="false"><i
                        class="bi bi-calendar4"></i><span class="nav-text">Tahun Akademik</span></a></li> --}}
            <li class="{{ request()->routeIs('laporan*') ? 'mm-active' : '' }}"><a href="{{ route('laporan.index') }}"
                    aria-expanded="false"><i class="bi bi-archive"></i><span class="nav-text">Laporan</span></a></li>
            @elseif (Auth::user()->roles == 'mhs')
            <li class="{{ request()->routeIs('formulir*') ? 'mm-active' : '' }}"><a href="{{ route('formulir.index') }}"
